...
class Fighter extends Sprite {
  ...
  switchSprite(sprite) {
    // override all with death animation
    ...
    if (this.image === this.sprites.attack1.image && this.framesCurrent < this.sprites.attack1.framesMax - 1) return // prevent attack animation from being interrupted && not get stuck in an infinite loop
    ...
    switch (sprite) {
      case "idle":
        if (this.image !== this.sprites.idle.image) {
          ...
          this.framesCurrent = 0 // to prevent glitching in switching to jump animation halfway through frame
        }
        break;
      case "run":
